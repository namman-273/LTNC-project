...
/**
 * Tests for:
 * - User.addBalance / deductBalance edge cases (NaN, Infinite, 0, negative,
 * overflow)
 * - User.addBalance / deductBalance thread-safety
 * - BidTransaction getters/setters/toString
 * - Item subclasses (Art, Electronics, Vehicle) basic props +
 * setCurrentPrice/setHighestBidder
