...
public class BalanceController implements Initializable {
    ...
    @FXML private void handleQuick100K()  { depositAmountField.setText("100000"); }
    ...
    private void handleDeposit() {
        ...
        if (amount.isEmpty()) { showMessage("Vui lòng nhập số tiền!", "orange"); return; }
    ...
    @FXML private void handleRefresh() { loadBalance(); }
